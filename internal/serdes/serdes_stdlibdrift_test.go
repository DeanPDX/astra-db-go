...
func TestTimeMarshaler_StdlibDivergence(t *testing.T) {
	...
	serdesOut, err := serdes.Serialize(w, serdes.CollectionTarget)
	if err != nil {
...
func TestTimeUnmarshaler_StdlibDivergence(t *testing.T) {
	...
	err := serdes.Deserialize(input, &serdesResult, serdes.CollectionTarget)
	if err != nil {
...
func TestCustomMarshaler_StdlibDivergence(t *testing.T) {
	...
	serdesOut, _ := serdes.Serialize(val, serdes.CollectionTarget) // 1999 (raw int)
...
func TestHTMLEscape_StdlibDivergence(t *testing.T) {
	...
	serdesOut, _ := serdes.Serialize(in, serdes.CollectionTarget)
...
func TestNilAstraCodecPointer_PanicAndDeadCode(t *testing.T) {
	...
	func() {
		...
		serdesOut, serdesErr = serdes.Serialize(nilPtr, serdes.CollectionTarget)
	}()
...
func TestRawMessage_SliceHeaderCorruption(t *testing.T) {
	...
	serdesOut, err := serdes.Serialize(in, serdes.CollectionTarget)
	if err != nil {
...
func TestLargePayload(t *testing.T) {
	...
	serdesJSON, err := serdes.Serialize(original, serdes.CollectionTarget)
	if err != nil {
		t.Fatalf("serdes marshal failed: %v", err)
	}
	...
	err = serdes.Deserialize(serdesJSON, &serdesRoundTripped, serdes.CollectionTarget)
	if err != nil {
